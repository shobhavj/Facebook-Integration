...
SWIFT_MODULE_NAMESPACE_PUSH("SwiftFacebookIntegration")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC24SwiftFacebookIntegration11AppDelegate")
...
SWIFT_CLASS("_TtC24SwiftFacebookIntegration29PostStatusTableViewController")
...
SWIFT_CLASS("_TtC24SwiftFacebookIntegration14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet FBSDKLoginButton * _Null_unspecified btnFacebook;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified ivUserProfileImage;
